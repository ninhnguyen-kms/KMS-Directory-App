...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const refreshContacts = async (): Promise<void> => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error.message || "Failed to refresh contacts",
      });
    } finally {
  ...
  const updateContact = async (
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error.message || "Failed to update contact",
      });
    }
  };
  ...
  const loadGroups = async (): Promise<void> => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error.message || "Failed to load groups",
      });
    }
  };
  ...
  const addUserToGroup = async (
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error.message || "Failed to add user to group",
      });
    }
  };
  ...
  const removeUserFromGroup = async (
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error.message || "Failed to remove user from group",
      });
    }
  };
  ...
  const deleteGroup = async (groupId: string): Promise<void> => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error.message || "Failed to delete group",
      });
    }
  };
